...
# for determining a EndUserProfile Habbits
...
class Receipt(models.Model):
    ...
    owner_id = models.ForeignKey(EndUserProfile,on_delete=models.CASCADE)
    #rfid_id = models.ForeignKey(Tag,on_delete=models.CASCADE)
    

class Prize(models.Model):
    prize_id = models.AutoField(primary_key=True)
    prizemanager_id = models.ForeignKey(EndUserProfile,on_delete=models.CASCADE)
